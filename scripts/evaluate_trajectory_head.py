"""Frozen early causal screen for a low-rank physical trajectory correction."""
...
from screen_trajectory_head import TrajectoryReadout
...
PROTOCOL = ROOT / "docs/harness/readout-trajectory-correction-screen-v1.json"
...
def source_binding(spec):
    ...
    return dict(
        ...
        candidate_sha256=digest(ROOT / "scripts/screen_trajectory_head.py"),
        runtime=dict(
...
def run_case(root, source, deadline):
    ...
    print(
        ...
        "250 ms",
        {
            ...
            for arm in ("candidate", "previous", "full")
        },
        "warm_ms",
...
def main():
    ...
    try:
        ...
        print(
            "manifest_sha256",
            seal(args.output, "glassbox-trajectory-head-screen-v1"),
            flush=True,
        )
