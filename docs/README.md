...
- [Charter](charter.md): product scope, definition of done and iteration rules.
...
- [Onboarding example](../examples/onboarding.py): the public API on analytic motion.

Earlier models, screens and Dart trials remain in Git history. They are not
alternative implementations or current performance claims.
