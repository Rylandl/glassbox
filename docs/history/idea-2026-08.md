> **Historical document.** This is the August 2026 project proposal, kept for
> provenance. It predates the belief, control, and bootstrap work and lists
> several of them as out of scope. The current scope is described in
> [scope.md](../scope.md).
