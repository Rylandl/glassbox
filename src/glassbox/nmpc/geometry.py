"""Differentiable rigid-body geometry used by the NMPC objective."""
...
def quaternion_log_error(reference_wxyz: Array, actual_wxyz: Array) -> Array:
    ...
    vector = relative[1:4]
    # The epsilon-smoothed vector norm preserves the correct small-angle
    # limit while keeping reverse-mode derivatives finite at identity.
